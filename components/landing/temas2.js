        ...
        <Row data-aos="fade-left">
            <ColHideOnPhone lg="3" md="4" >
                <div className="icon-box" style={{ display: "flex", alignItems: "center" }} data-aos="zoom-in" data-aos-delay="50">
                    <AppImageHot src="img/landing/Hot.png" className="img-fluid" alt="" />
                    <h3><a>Hot</a></h3>
                </div>
            </ColHideOnPhone>
            <ColHideOnPhone lg="3" md="4" >
                <div className="icon-box" style={{ display: "flex", alignItems: "center" }} data-aos="zoom-in" data-aos-delay="50">
                    <AppImageGustos src="img/landing/Gustos.png" className="img-fluid" alt="" />
                    <h3><a>Gustos</a></h3>
                </div>
            </ColHideOnPhone>
            <ColHideOnPhone lg="3" md="4" >
                <div className="icon-box" style={{ display: "flex", alignItems: "center" }} data-aos="zoom-in" data-aos-delay="50">
                    <AppImageFantasias src="img/landing/Fantasias.png" className="img-fluid" alt="" />
                    <h3><a>Fantasías</a></h3>
                </div>
            </ColHideOnPhone>
            <Col lg="3" md="4" >
                <div className="icon-box" style={{ display: "flex", alignItems: "center" }} data-aos="zoom-in" data-aos-delay="50">
                    <AppImageDudas src="img/landing/Dudas.png" className="img-fluid" alt="" />
                    <h3><a>Dudas</a></h3>
                </div>
            </Col>
            <ColHideOnPhone lg="3" md="4" >
                <div className="icon-box" style={{ display: "flex", alignItems: "center" }} data-aos="zoom-in" data-aos-delay="50">
                    <AppImageJuegos src="img/landing/Juegos.png" className="img-fluid" alt="" />
                    <h3><a>Juegos</a></h3>
                </div>
            </ColHideOnPhone>
            <Col lg="3" md="4" >
                <div className="icon-box" style={{ display: "flex", alignItems: "center" }} data-aos="zoom-in" data-aos-delay="50">
                    <AppImageRelaciones src="img/landing/Relaciones.png" className="img-fluid" alt="" />
                    <h3><a>Relaciones</a></h3>
                </div>
            </Col>
            <Col lg="3" md="4" >
                <div className="icon-box" style={{ display: "flex", alignItems: "center" }} data-aos="zoom-in" data-aos-delay="50">
                    <AppImageHabitos src="img/landing/Habitos.png" className="img-fluid" alt="" />
                    <h3><a>Hábitos</a></h3>
                </div>
            </Col>
            <ColHideOnPhone lg="3" md="4" >
                <div className="icon-box" style={{ display: "flex", alignItems: "center" }} data-aos="zoom-in" data-aos-delay="50">
                    <AppImageBizarro src="img/landing/Bizarro.png" className="img-fluid" alt="" />
                    <h3><a>Bizzarro</a></h3>
                </div>
            </ColHideOnPhone>
            <ColHideOnPhone lg="3" md="4" >
                <div className="icon-box" style={{ display: "flex", alignItems: "center" }} data-aos="zoom-in" data-aos-delay="50">
                    <AppImagePrimera src="img/landing/Primera.png" className="img-fluid" alt="" />
                    <h3><a>Primeras veces</a></h3>
                </div>
            </ColHideOnPhone>
            <ColHideOnPhone lg="3" md="4" >
                <div className="icon-box" style={{ display: "flex", alignItems: "center" }} data-aos="zoom-in" data-aos-delay="50">
                    <AppImageLevante src="img/landing/Levante.png" className="img-fluid" alt="" />
                    <h3><a>De levante</a></h3>
                </div>
            </ColHideOnPhone>
            <ColHideOnPhone lg="3" md="4" >
                <div className="icon-box" style={{ display: "flex", alignItems: "center" }} data-aos="zoom-in" data-aos-delay="50">
                    <AppImageSOS src="img/landing/SOS.png" className="img-fluid" alt="" />
                    <h3><a>WeSexers S.O.S</a></h3>
                </div>
            </ColHideOnPhone>
            <Col lg="3" md="4" >
                <div className="icon-box" style={{ display: "flex", alignItems: "center" }} data-aos="zoom-in" data-aos-delay="50">
                    <AppImageOtros src="img/landing/Otros.png" className="img-fluid" alt="" />
                    <h3><a>Otros</a></h3>
                </div>
            </Col>
          </Row>
