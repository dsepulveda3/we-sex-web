            ...
            <Background>
              <Container>
                    ...
                    <Row className="justify-content-between" style={{backgroundColor: "var(--green)", marginTop: "2rem", marginBottom: "2rem", padding: "1rem"}}>  
                            ...
                            <Text2>
                                <span>Lau, hoy te toca realizar un masaje relajante y/o erótico a Nori. Sin expectativas de que lleve a algo más, simplemente para que él se sienta bien y relajado.</span>
                                <br/>
                                <br/>
                                Puedes preguntarle a Nori cómo le gustaría que sea el masaje, pero igualmente…
                                <br/>
                            </Text2>
