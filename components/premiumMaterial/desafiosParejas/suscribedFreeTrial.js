...
import { create_couple_free_trial } from '../../../requests/premiumService';
...
const SuscribedFreeTrial = () => {
    ...
    const handleStepOneSubmit = async () => {
        ...
        try{
            const response = await create_couple_free_trial({
      ...
      <section id="hola">
        <Background>
          <ContainerInfo>
            ...
            <Content>
                <Title>
                    <span>¡FELICITACIONES!</span> Bienvenidos a la prueba gratuita del programa para innovar en pareja.
                </Title>
  ...
  export default SuscribedFreeTrial;