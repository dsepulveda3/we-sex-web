    ...
    return(
        <Background>
            ...
            <Header>
                ...
                <Feedback challengeName={"Extrañarse lindo"}/>
            </Header>
            <Logo src='/img/logo_wesex_croped.png' />
            
            {/* <Title>Agradecimientos diarios</Title> */}
            <SubTitle>Extrañarse lindo</SubTitle>

            
            <Text style={{padding: "2rem"}}>
                Les dejamos 4 consignas para charlar sobre cómo extrañarse lindo: 
                <br/>
                <br/>

                <ul>
                    <li>
                        Cuéntale a tu pareja qué sientes en el cuerpo cuando le extrañas. 
                    </li>
                    <li>
                        Digan del 1 al 10 cuán importante es sostener los espacios individuales que son la fuente del extrañarse.
                    </li>
                    <li>
                        ¿Con qué frecuencia se ven entre ustedes sin otras personas? 
                    </li>
                    <li>
                        ¿Cuál sería la frecuencia ideal para ambxs respetando las individualidades?
                    </li>
                </ul>
            </Text>
