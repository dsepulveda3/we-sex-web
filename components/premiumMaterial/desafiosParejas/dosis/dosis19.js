    ...
    return(
        <Background>
            ...
            <Header>
                ...
                <Feedback challengeName={"Desbloquearse"}/>
            </Header>
            <Logo src='/img/logo_wesex_croped.png' />
            
            {/* <Title>Agradecimientos diarios</Title> */}
            <SubTitle>Desbloquearse</SubTitle>

            
            <Text style={{padding: "2rem"}}>
            Cuéntale ahora mismo a tu compa que parte de tu cuerpo sientes trabada, bloqueada, contracturada o dolida y pedile mimos ahí por 5 minutos. 
            Luego cambien los roles.
            </Text>
