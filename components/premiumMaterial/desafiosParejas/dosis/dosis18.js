    ...
    return(
        <Background>
            ...
            <Header>
                ...
                <Feedback challengeName={"¿Qué nos enamora de la vida?"}/>
            </Header>
            <Logo src='/img/logo_wesex_croped.png' />
            
            {/* <Title>Agradecimientos diarios</Title> */}
            <SubTitle>¿Qué nos enamora de la vida?</SubTitle>

            
            <Text style={{padding: "2rem"}}>
            Cuenten tres experiencias que les generen bienestar más allá de lo vincular. 
            Descubran cosas que a su pareja les den felicidad, charlen de que cosas también puede ser que antes amaban y ahora no tanto. 
            Es importante la intimidad de compartir los deseos profundos de nuestros vínculos.
            </Text>
