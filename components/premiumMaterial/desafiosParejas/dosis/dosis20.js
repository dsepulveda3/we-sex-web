    ...
    return(
        <Background>
            ...
            <Header>
                ...
                <Feedback challengeName={"Piojitos"}/>
            </Header>
            <Logo src='/img/logo_wesex_croped.png' />
            
            {/* <Title>Agradecimientos diarios</Title> */}
            <SubTitle>Piojitos</SubTitle>

            
            <Text style={{padding: "2rem"}}>
                Una persona se acuesta en un sillón colocando la cabeza sobre los muslos de la otra y se hacen masajes en el pelo/cabello por 5 minutos. 
