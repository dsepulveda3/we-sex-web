    ...
    return(
        <Background>
            ...
            <Header>
                ...
                <Feedback challengeName={"Deseos a corto plazo"}/>
            </Header>
            <Logo src='/img/logo_wesex_croped.png' />
            
            {/* <Title>Agradecimientos diarios</Title> */}
            <SubTitle>Deseos a corto plazo</SubTitle>

            
            <Text style={{padding: "2rem"}}>
                Comparte con tu pareja al menos tres cosas que te gustaría experimentar en los próximos meses. 
                Puede ser la incorporación de algún dispositivo o herramienta novedosa, la exploración de nuevas técnicas o la planificación de actividades emocionantes para los meses que están por venir.
            </Text>
