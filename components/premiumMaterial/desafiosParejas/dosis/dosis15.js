    ...
    return(
        <Background>
            ...
            <Header>
                ...
                <Feedback challengeName={"Consulta de decisiones"}/>
            </Header>
            <Logo src='/img/logo_wesex_croped.png' />
            
            {/* <Title>Agradecimientos diarios</Title> */}
            <SubTitle>Consulta de decisiones</SubTitle>

            
            <Text style={{padding: "2rem"}}>
            Tener en cuenta el punto de vista de nuestro vínculo es clave en el proceso de confianza y respeto mutuo. 
            Te invitamos a que hoy cultives esto con la siguiente acción:
                ...
                <ul>
                    <li>
                        Dile a tu pareja lo mucho que te gustó cuando, ante una difícil toma de decisión, te pidió asesoría. 
                    </li>
                    <li>
                        Describir cómo te sentiste en ese momento, qué emociones te atravesaron.  
                    </li>
                    <li>
                        Pueden recordar la situación y cómo cambió todo al abrirse y mostrarse vulnerables.
                    </li>
                </ul>
            </Text>
