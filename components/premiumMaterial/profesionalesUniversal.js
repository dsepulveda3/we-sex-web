...
const ProfesionalesUniversal = ({fabiVisibility, ceciliaVisibility, barbaraVisibility, laraVisibility, fernandaVisibility}) => {
...
export default ProfesionalesUniversal;