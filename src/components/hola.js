        ...
        <Background>
            <Container>
                    <Row className="justify-content-between">
                        <Col lg={7} className="align-items-center">
                            <Content>
                                ...
                                <a href="https://apps.apple.com/us/app/wesex/id1526063508" target="_blank">
                                    <AppImageAppStore src="img/bt_appstore_off.png" alt="Sexo Anal, como nunca antes gozado." />
                                </a>
                                <a href="https://apps.apple.com/us/app/wesex/id1526063508" target="_blank">
                                    <AppImagePlayStore src="img/bt_playstore_off.png" alt="Sexo Anal, como nunca antes gozado." />
                                </a>
                        ...
                        <Col>
                            <ContentImage>
                                <AppImage src="img/hero-img.png" alt="Sexo Anal, como nunca antes gozado." />
                            </ContentImage>
                        </Col>
                    </Row>
            </Container>
