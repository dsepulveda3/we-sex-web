 ...
 export default function PaymentButton() {
   ...
   useEffect(() => {
     const createPreference = async () => {
       const response = await fetch("/api/create-preferences-tantra-email-c");
        ...
        <Text4>Luego de comprar la guía la recibirás por email</Text4>
            ...
            {isVisible && (
                ...
                <div style={{ paddingTop: "5rem"}}>
                  ...
                  <BotonVioleta className="pagoPH" ref={botonPagoRef} id="boton-pago" target="_blank" href={`https://payhip.com/b/jR26I${affiliate}`}>
                      Pago en USD
                  </BotonVioleta>
                  <Amount>U$D  5</Amount>
                </div>
            ...
            <Link href="/premium-material/guides/guia-pack-anal-tantra-email-c">
