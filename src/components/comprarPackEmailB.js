...
export default function PaymentButton() {
   ...
   useEffect(() => {
     const createPreference = async () => {
       const response = await fetch("/api/create-preferences-anal-tantra-email-b");
   ...
   return (
    ...
    <Background id="comprar">
          <Container style={{paddingTop: "5rem", paddingBottom: "6rem", textAlign: "center"}}>
              ...
              <Amount><span>AR$ 2.000</span>  AR$ 1.600</Amount>
              <Title style={{marginTop: "5rem"}}>Compra internacionalmente</Title>
              <BotonVioleta className="pagoPH" id="boton-pago" target="_blank" href={`https://payhip.com/b/Op7HD${affiliate}`}>
                  Pago en USD
              </BotonVioleta>
              <Amount><span>U$D  10</span>  U$D  8</Amount>
          </Container>
      </Background>
  </div>
    );
