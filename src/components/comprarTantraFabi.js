 ...
 export default function PaymentButton() {
   ...
   useEffect(() => {
     const createPreference = async () => {
       const response = await fetch("/api/create-preferences-tantra-fabi");
      ...
      <Container style={{ paddingBottom: "6rem", textAlign: "center", display: "flex", flexDirection: "column", alignItems: "center"}}>
            ...
            {isVisible && (
                ...
                <div style={{ paddingTop: "5rem"}}>
                  ...
                  <BotonVioleta className="pagoPH" ref={botonPagoRef} id="boton-pago" target="_blank" href={`https://payhip.com/b/wrBYp${affiliate}`}>
                      Pago en USD
                  </BotonVioleta>
                  <Amount>U$D  5</Amount>
                </div>
            ...
            <Link href="/premium-material/guides/guia-pack-anal-tantra-fabi">
