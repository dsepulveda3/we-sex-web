      ...
      <Background>
        <Container>
          ...
          <div>
            ...
            <CustomNextArrow src='/img/ico/next_arrow_white.png' className="swiper-button-next" onClick={handleNext} />
            <CustomPrevArrow src='/img/ico/previous_arrow_white.png' className="swiper-button-prev" onClick={handlePrev} />
