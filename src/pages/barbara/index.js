  ...
  return (
    <>
      ...
      <main>
        ...
        <Regalar />
        <ComprarUniversal title_mp='B - Guía sexo Anal - WeSex (R: Barbara)' unit_price_mp= {1000} quantity_mp={1} currency_id_mp='ARS'
          price_ARG='AR$  1000' price_USD='U$D  5' redirection_succesful_mp='https://payhip.com/b/LRZC1' 
