...
export default async function handler(req, res) {
  const preference = {
    items: [
      {
        title: "B - Guía sexo Anal - WeSex (R: Barbara)",
        unit_price: 800,
        quantity: 1,
        currency_id: "ARS",
      },
    ...
    back_urls: {
      success: "https://payhip.com/b/LRZC1",
      failure: "https://we-sex-landing-guia-sexo-anal-git-main-lucasadlerstein.vercel.app/barbara",
      pending: "https://we-sex-landing-guia-sexo-anal-git-main-lucasadlerstein.vercel.app/barbara",
    },
