  ...
  return (
    <>
      ...
      <main>
        ...
        <Profesionales />
        <Dudas />
        <ComprarUniversal title_mp='Discount - MasterSex Class: revoluciona tu vida sexual' unit_price_mp= {3600} quantity_mp={1} currency_id_mp='ARS'
          price_before_ARG='AR$  4000' price_ARG='AR$  3600' price_USD='U$D  15' redirection_succesful_mp='https://payhip.com/b/U906i' 
          redirection_failed_mp='https://we.sex/premium-material/masters/masterclass-discount'
