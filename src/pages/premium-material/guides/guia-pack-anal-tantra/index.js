  ...
  return (
    <>
      ...
      <main>
        ...
        <Profesionales />
        <Regalar /> */}
        <ComprarUniversal title_mp='Guía Sexo Anal + Tantra - WeSex' unit_price_mp= {1600} quantity_mp={1} currency_id_mp='ARS'
          price_before_ARG='AR$  2000' price_ARG='AR$  1600' price_before_USD='U$D  10' price_USD='U$D  8' redirection_succesful_mp='https://payhip.com/b/6LF0K' 
          redirection_failed_mp='https://www.we.sex/premium-material/guides/guia-pack-anal-tantra'
          link_payhip_usd='https://payhip.com/b/dgnYh' has_promo={false}
        />
        {/* <Dudas />
        <AboutWeSex />
        <SeguisDudando /> */}
