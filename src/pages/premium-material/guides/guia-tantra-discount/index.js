  ...
  return (
    <>
      ...
      <main>
        {/* <NavBarWS /> */}
        <HeaderPremium />
        <FirstBannerUniversal titleText='Guía de tantra:' titleSpan='orgasmos más profundos' price='AR$ 1600  /  U$D 6' description1='Te enseñamos de 0 a 100,' 
        ...
        <Pack/>
        <Regalar />
        <ComprarUniversal title_mp='Discount - Guía Tantra - WeSex' unit_price_mp= {1000} quantity_mp={1} currency_id_mp='ARS'
          price_before_ARG='AR$  1600' price_ARG='AR$  1000' price_before_USD='U$D  6' price_USD='U$D  2.5' redirection_succesful_mp='https://payhip.com/b/bweh6' 
