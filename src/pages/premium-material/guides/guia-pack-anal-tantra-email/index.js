  ...
  return (
    <>
      ...
      <main>
        {/* <NavBarWS /> */}
        <HeaderPremium />
        <FirstBannerUniversal titleText='Guía de ' titleSpan='Sexo Anal + Tantra' price='AR$ 4500  /  U$D 10' description1='Compra el pack' 
        ...
        <Profesionales />
        <Regalar /> */}
        <ComprarUniversal title_mp='EM - Guía Sexo Anal + Tantra - WeSex' unit_price_mp= {2400} quantity_mp={1} currency_id_mp='ARS'
          price_before_ARG='AR$  3200' price_ARG='AR$  2400' price_before_USD='U$D  12' price_USD='U$D  10' redirection_succesful_mp='https://payhip.com/b/LwV2S' 
          redirection_failed_mp='https://www.we.sex/premium-material/guides/guia-pack-anal-tantra-email'
          link_payhip_usd='https://payhip.com/b/5dwLf' has_promo={false}
        />
        {/* <Dudas />
        <AboutWeSex />
        <SeguisDudando /> */}
