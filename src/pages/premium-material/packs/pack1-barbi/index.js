  ...
  return (
    <>
      ...
      <main>
        ...
        <Profesionales />
        <Regalar /> */}
        <ComprarUniversal title_mp='B - Guía Zonas Erógenas + Anal + Tantra - WeSex' unit_price_mp= {3000} quantity_mp={1} currency_id_mp='ARS'
          price_before_ARG='AR$  4500' price_ARG='AR$  3000' price_before_USD='U$D  15' price_USD='U$D  12' redirection_succesful_mp='https://payhip.com/b/Usg5P' 
