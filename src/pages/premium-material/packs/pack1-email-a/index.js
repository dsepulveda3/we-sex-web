  ...
  return (
    <>
      ...
      <main>
        {/* <NavBarWS /> */}
        <HeaderPremium />
        <FirstBannerUniversal titleText='Guías de ' titleSpan='Zonas Erógenas + Anal + Tantra' price_before= 'AR$ 4500  /  U$D 15' price='AR$ 3.000  /  U$D 12' description1='Llevate 3, paga 2 :) .' 
        ...
        <Profesionales />
        <Regalar /> */}
        <ComprarUniversal title_mp='EMA - Guía Zonas Erógenas + Anal + Tantra - WeSex' unit_price_mp= {3000} quantity_mp={1} currency_id_mp='ARS'
          price_before_ARG='AR$  4500' price_ARG='AR$  3000' price_before_USD='U$D  15' price_USD='U$D  12' redirection_succesful_mp='https://payhip.com/b/aJStQ' 
          redirection_failed_mp='https://www.we.sex/packs/pack1-email-a'
          link_payhip_usd='https://payhip.com/b/LcHZp' has_promo={false}
        />
        {/* <Dudas />
        <AboutWeSex />
        <SeguisDudando /> */}
