...
export default function Pack12() {
  useEffect(() => {
    ...
    if (typeof window !== 'undefined') {
      // This code will only run on the client side
        ...
        if(currentRoute === '/premium-material/packs/pack12-Deseo-SR'){
            freshpaint.track("Page View - Pack Deseo + Rutina", {"Path": currentRoute});
        }
  ...
  return (
    <>
      ...
      <Layout >
        ...
        <ComprarUniversal title_mp='Guía Deseo + Salir de la rutina - WeSex' 
          ...
          redirection_succesful_mp='https://payhip.com/b/ZgI6G' 
          redirection_failed_mp='https://www.we.sex/premium-material/packs/pack12-Deseo-SR'
          link_payhip_usd='https://payhip.com/b/tGjyQ' has_promo={true}
