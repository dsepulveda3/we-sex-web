...
export default function Pack11() {
  useEffect(() => {
  ...
  return (
    <>
      ...
      <Layout >
        ...
        <ComprarUniversal title_mp='Guía Menopausia + Salir de la rutina - WeSex' 
          ...
          redirection_succesful_mp='https://payhip.com/b/E4lJa' 
          redirection_failed_mp='https://www.we.sex/premium-material/packs/pack11-Meno-R'
          link_payhip_usd='https://payhip.com/b/9sdFa' has_promo={true}
