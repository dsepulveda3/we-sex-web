...
export default function Pack14Fer() {
  useEffect(() => {
    ...
    if (typeof window !== 'undefined') {
      // This code will only run on the client side
        ...
        if(currentRoute === '/premium-material/packs/pack14-eight-guides-fer'){
            freshpaint.track("FER - Page View - Eight Guides", {"Path": currentRoute});
        }
    ...
    <>
      ...
      <FirstBannerUniversal titleText='Por $16,000 llevate ' titleSpan=' 8 guías de WeSex y aprende TODO sobre sexo.'  
        ...
        <ComprarUniversal title_mp='FER - Pack 8 Guías - WeSex' 
          ...
          redirection_succesful_mp='https://payhip.com/b/e3hgP'
          redirection_failed_mp='https://www.we.sex/premium-material/packs/pack14-eight-guides-fer'
          link_payhip_usd='https://payhip.com/b/NIT8j' has_promo={true}
