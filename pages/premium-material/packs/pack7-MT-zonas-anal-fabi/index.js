...
export default function Pack7Fabi() {
  ...
  return (
    <>
      ...
      <Layout >
        ...
        <AfterDiv />
        <ComprarUniversal title_mp='F - Guía Masturbación Tántrica + Zonas Erógenas + Anal - WeSex'
          ...
          redirection_succesful_mp='https://payhip.com/b/S3lJb' 
          redirection_failed_mp='https://www.we.sex/packs/pack7-MT-zonas-anal'
          link_payhip_usd='https://payhip.com/b/KyDhZ' has_promo={true}
