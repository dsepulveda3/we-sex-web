...
export default function Pack8() {
  
  return (
    <>
      <Head>
        <title>Pack WeSexer - WeSex</title>
        <meta name="description" content="Guía WeSexer - WeSex" /> 
      ...
      <main>
      <Layout >
        <FirstBannerUniversal titleText='Guías' titleSpan='Masturbación Tántrica + Salir de la Rutina + Zonas Erógenas + Tantra + Anal' 
          price_before={`AR$ ${globalPrices.OneProductARS*5}  /  U$D ${globalPrices.OneProductUSD*5}`}
          price={`AR$ ${globalPrices.FiveProductARS}  /  U$D ${globalPrices.FiveProductUSD}`}
          description1='Llevate 5, paga 4 :) .' 
        ...
        <ComprarUniversal title_mp='Guía Masturbación Tántrica + Zonas Erógenas + Anal - WeSex' 
          unit_price_mp= {globalPrices.FiveProductARS} 
