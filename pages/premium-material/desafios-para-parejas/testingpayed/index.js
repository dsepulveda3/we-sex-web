...
const ABTestPagePayed = () => {
  ...
  useEffect(() => {
    ...
    if (userSegment !== null && typeof window !== 'undefined' && origin !== null) {
      const nextPage =
        userSegment === 0
          ? `/premium-material/desafios-para-parejas/testingpayed-a?origin=${origin}`
          : `/premium-material/desafios-para-parejas/testingpayed-b?origin=${origin}`;
...
export default ABTestPagePayed;
