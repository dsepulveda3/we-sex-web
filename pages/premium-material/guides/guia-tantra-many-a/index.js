    ...
    <>
      ...
      <Layout>
        ...
        <ComprarUniversal title_mp='Guía Tantra- WeSex' 
          unit_price_mp= {3200} quantity_mp={1} currency_id_mp='ARS'
          price_ARG={`AR$ 3200`} 
          price_USD={`U$D 6`} 
          redirection_succesful_mp='https://payhip.com/b/Kvlko' 
          redirection_failed_mp='https://we.sex/premium-material/guides/guia-tantra-many-a'
          link_payhip_usd='https://payhip.com/b/G9Hhj' has_promo={true}
