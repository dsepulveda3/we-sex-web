  ...
  return (
    <>
      ...
      <Layout>
        ...
        title1_3='a un precio orgasmico' link_promo='/premium-material/guides/guia-pack-anal-tantra' />
        <Regalar />
        <ComprarUniversal title_mp='Guía Tantra- WeSex' 
          unit_price_mp= {5000} quantity_mp={1} currency_id_mp='ARS'
          price_ARG={`AR$ 5000`} 
          price_USD={`U$D 6`} 
          redirection_succesful_mp='https://payhip.com/b/Fm2T4' 
          redirection_failed_mp='https://we.sex/premium-material/guides/guia-tantra-many-a'
          link_payhip_usd='https://payhip.com/b/GdXwM' has_promo={true}
