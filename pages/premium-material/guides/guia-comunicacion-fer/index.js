...
export default function ComunicacionFer() {
  useEffect(() => {
    ...
    if (typeof window !== 'undefined') {
      // This code will only run on the client side
        ...
        if(currentRoute === '/premium-material/guides/guia-comunicacion-fer'){
            freshpaint.track("FER - Page View - Guía Comunicacion", {"Path": currentRoute});
        }
  ...
  return (
    <>
      ...
      <Layout>
        ...
        link_promo='/premium-material/packs/pack14-eight-guides-fer' />
        <Regalar />
        <ComprarUniversal title_mp='FER - Guía Comunicación Asertiva - WeSex' unit_price_mp= {globalPrices.OneProductARS} quantity_mp={1} currency_id_mp='ARS'
          price_ARG={`AR$ ${globalPrices.OneProductARS}`} 
          price_USD={`U$D ${globalPrices.OneProductUSD}`} 
          redirection_succesful_mp='https://payhip.com/b/pwaSi' 
          redirection_failed_mp='https://www.we.sex/premium-material/guides/guia-comunucacion-fer'
          link_payhip_usd='https://payhip.com/b/pzq3l'
          has_promo={true}
          buy_just='Comprar guía de Comunicación' reminder_buy_just='Estás comprando solo la guía de Comunicación' 
          link_promo='' text_promo1_1=''
          text_promo1Span='' text_promo1_2=''
          link_promo2='/premium-material/packs/pack13-Comu-Deseo-SR-fer' text_promo2_1='O llevate la '
