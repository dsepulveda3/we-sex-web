...
export default function MasturbacionTantricaEmail() {
  
  return (
    <>
      <Head>
        <title>EM - Guía Masturbación Tántrica - WeSex</title>
        <meta name="description" content="EM - Guía Masturbación Tántrica - WeSex" /> 
      ...
      <Layout>
        ...
        title1_3='Masturbación Tántrica, Zonas Erógenas, Sexo Anal.' link_promo='/premium-material/packs/pack7-MT-zonas-anal-email' />
        <Regalar />
        <ComprarUniversal title_mp='EM - Guía Masturbación Tántrica - WeSex' unit_price_mp= {globalPrices.OneProductARS} quantity_mp={1} currency_id_mp='ARS'
