  ...
  return (
    <>
      ...
      <Layout >
        ...
        title1_3='Zonas Erógenas + Sexo Anal + Tantra' link_promo='/premium-material/packs/pack1-email-c' />
        <ComprarUniversal title_mp='EMC - Guía Zonas Erógenas - WeSex' unit_price_mp= {globalPrices.OneProductARS} quantity_mp={1} currency_id_mp='ARS'
          price_ARG={`AR$ ${globalPrices.OneProductARS}`} price_USD={`U$D ${globalPrices.OneProductUSD}`} redirection_succesful_mp='https://payhip.com/b/ATYyK' 
          redirection_failed_mp='https://www.we.sex/premium-material/guides/guia-zonas-erogenas'
          link_payhip_usd='https://payhip.com/b/0qgyt' has_promo={true}
          ...
          link_promo2='/premium-material/packs/pack2-email-c' text_promo2_1='O llevate la '
