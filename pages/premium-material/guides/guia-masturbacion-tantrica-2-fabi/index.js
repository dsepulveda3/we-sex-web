...
import DisclaimerTantraFabi from '../../../../components/premiumMaterial/disclaimerTantraFabi'


export default function GuiaMasturbacion2Fabi() {
    ...
    <>
      ...
      <Layout>
        ...
        <ComprarUniversal title_mp='F - Guía Masturbación Tántrica 2 - WeSex' unit_price_mp= {globalPrices.OneProductARS} quantity_mp={1} currency_id_mp='ARS'
          ...
          redirection_succesful_mp='https://payhip.com/b/5lAVu' 
          redirection_failed_mp='https://www.we.sex/premium-material/guides/guia-masturbacion-tantrica-2-fabi'
          link_payhip_usd='https://payhip.com/b/Ns8Gu' 
          has_promo={true}
