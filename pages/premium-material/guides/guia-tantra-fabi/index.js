  ...
  return (
    <>
      ...
      <Layout >
        ...
        title1_3='a un precio orgasmico' link_promo='/premium-material/guides/guia-pack-anal-tantra-fabi' />
        <Regalar />
        <ComprarUniversal title_mp='F - Guía Tantra- WeSex' unit_price_mp= {globalPrices.OneProductARS} quantity_mp={1} currency_id_mp='ARS'
          price_ARG={`AR$ ${globalPrices.OneProductARS}`} price_USD={`U$D ${globalPrices.OneProductUSD}`} redirection_succesful_mp='https://payhip.com/b/lqoxY' 
          redirection_failed_mp='https://www.we.sex/premium-material/guides/guia-tantra-fabi'
          link_payhip_usd='https://payhip.com/b/wrBYp' has_promo={true}
          buy_just='Comprar solo guía tantra' reminder_buy_just='Estás comprando solo la guía de Tantra' 
          link_promo='/premium-material/guides/guia-pack-anal-tantra-fabi' text_promo1_1='O llevate la '
